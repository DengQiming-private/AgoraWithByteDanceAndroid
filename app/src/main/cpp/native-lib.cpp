...
extern "C" JNIEXPORT int JNICALL Java_com_bytedance_labcv_AgoraByteDanceNative_setParameters(
        JNIEnv* env,
...
Java_com_bytedance_labcv_AgoraByteDanceNative_setContext(
        JNIEnv* env,
...
Java_com_bytedance_labcv_AgoraByteDanceNative_isEnable(
        JNIEnv* env,
        jclass clazz) {
    CHECK_PLUGIN_MANAGER_INT;
...
extern "C" JNIEXPORT int JNICALL
Java_com_bytedance_labcv_AgoraByteDanceNative_setEnable(
        JNIEnv* env,
...
extern "C" JNIEXPORT int JNICALL
Java_com_bytedance_labcv_AgoraByteDanceNative_releaseContext(
        JNIEnv* env,
        jclass clazz) {
